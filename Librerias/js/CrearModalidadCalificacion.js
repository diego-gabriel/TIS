$(document).ready(function(){        
           ...
           $('#tipo_criterio').on('change', function() {
                ...
                if(valor == 2)
                {
                    ...
                    $('#Textos').append('<div class="form-group">Verdadero:&nbsp<input type="text" name="ValorNumerico[]" placeholder="Puntaje: 70,80,90" pattern="^[1-9]{1}[0-9]{1,3}" required></div>')
                    

                    $('#Textos').append('<div class="form-group"><input type="hidden" name="Indicador[]" value="Falso"></div>')
                    $('#Textos').append('<div class="form-group">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspFalso:&nbsp<input type="text" name="ValorNumerico[]" placeholder="Puntaje: 10,20,30" pattern="^[1-9]{1}[0-9]{1,3}" required></div>')
                ...
                if(valor == 3)
                {
                    ...
                    $('#Textos').append('<div class="form-group">&nbspSi:&nbsp<input type="text" name="ValorNumerico[]" placeholder="Puntaje: 70,80,90" pattern="^[1-9]{1}[0-9]{1,3}" required></div>')
                    

                    $('#Textos').append('<div class="form-group"><input type="hidden" name="Indicador[]" value="No"></div>')
                    $('#Textos').append('<div class="form-group">No:&nbsp<input type="text" name="ValorNumerico[]" placeholder="Puntaje: 10,20,30" pattern="^[1-9]{1}[0-9]{1,3}" required></div>')
