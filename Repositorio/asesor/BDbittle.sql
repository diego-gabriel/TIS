...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-11-2014 a las 17:02:54
...
('Colective', 'Colective', 'Colective SRL', 'calle rosetti #654', 'David Mercado');
...
(4, 'Leticia', 'Prueba de foto', '2014-11-11 04:36:22', 3, 'probando el foro');
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AVG_ROW_LENGTH=8192 AUTO_INCREMENT=102 ;
...
('Colective', 'Habilitado', 'Colective*123', '4789865', 'colective@gmail.com'),
...
CREATE TABLE IF NOT EXISTS `proyecto` (
  ...
  PRIMARY KEY USING BTREE (`CODIGO_P`, `ID_G`),
  INDEX `fk_proyecto_gestion1_idx` (`ID_G` ASC),
  CONSTRAINT `fk_proyecto_gestion1`
    FOREIGN KEY (`ID_G`)
    REFERENCES `gestion` (`ID_G`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
AUTO_INCREMENT = 3
...
--
-- -----------------------------------------------------
-- Table `inscripcion_proyecto`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `inscripcion_proyecto` (
  `CODIGO_P` INT(11) NOT NULL,
  `NOMBRE_U` VARCHAR(50) NOT NULL,
  PRIMARY KEY (`CODIGO_P`, `NOMBRE_U`),
  INDEX `fk_inscripcion_proyecto_proyecto1_idx` (`CODIGO_P` ASC),
  INDEX `fk_inscripcion_proyecto_grupo_empresa1_idx` (`NOMBRE_U` ASC),
  CONSTRAINT `fk_inscripcion_proyecto_proyecto1`
    FOREIGN KEY (`CODIGO_P`)
    REFERENCES `proyecto` (`CODIGO_P`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_inscripcion_proyecto_grupo_empresa1`
    FOREIGN KEY (`NOMBRE_U`)
    REFERENCES `grupo_empresa` (`NOMBRE_U`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB; 
